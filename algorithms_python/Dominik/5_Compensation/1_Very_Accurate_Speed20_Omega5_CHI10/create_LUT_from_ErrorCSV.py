...
rawdf = read_csv('2021_09_10_13:44:08_measure_Smargon_Error_OXOY_CHI0_40.csv')

#Aufbereiten der Daten
rawdf['time']=rawdf['DMS_Secs']+rawdf['DMS_Nsecs']*1e-9
rawdf['OMEGA_Cont']=(rawdf['OMEGA_Cont'])
rawdf['X']=(rawdf['DMS_X']-3.90594) #mit Offset zu 0 Referenz
rawdf['Y']=(rawdf['DMS_Y']-0.21995) #mit Offset zu 0 Referenz
rawdf['Z']=(rawdf['DMS_Z']-0.68850) #mit Offset zu 0 Referenz


# Relevante Daten deklarieren
#df = rawdf[500:20900] # Auswertung startet ab Zeile 400 und endet mit Zeile 20900
df = rawdf[:] # Auswertung der ganzen Tabelle
