...
# Dieses Script verfaehrt den Aerotech translativ mit GMZ.
...
for i in range(0,Step1,1):
    print("Move GMZ to +0.001")
    epics.caput("X06MX-ES-DF1:GMZ-INCP",0.001)
    time.sleep(2.5)
...
for i in range(0,Step3,1):
    print("Move GMZ to +0.003")
    epics.caput("X06MX-ES-DF1:GMZ-INCP",0.003)
    time.sleep(2.5)
