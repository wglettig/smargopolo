...
def create_CSV_File():
    ...
    with open(day+'checkLinearity_GMX.csv', 'w', newline='') as file:
...
#    plt.plot(p_x, '-r', label="Z")
    ...
    with open(day+'checkLinearity_GMX.csv', 'a', newline='') as file:
        writer = csv.writer(file)
...
def checkLinearity_GMX_routine():
    ...
    #get Aerotechepics.caput
    OmegaRDB=epics.caget("X06MX-ES-DF1:OMEGA-RBV")
    OmegaRDB=round(OmegaRDB, 2)
    
    if get_CHI==0 and OmegaRDB == 0:
            
        print("Move GMX to 73 degree")
        epics.caput("X06MX-ES-DF1:GMX-SETV",1)
        epics.caput("X06MX-ES-DF1:GMX-INCP",0.02)
        time.sleep(5)
        print("Move GMZ to 5 degree")
        epics.caput("X06MX-ES-DF1:GMZ-SETV",1)
        epics.caput("X06MX-ES-DF1:GMZ-INCP",0.01)
        time.sleep(5)
        print("Move GMX to 93 degree")
        epics.caput("X06MX-ES-DF1:GMX-SETV",1)
        epics.caput("X06MX-ES-DF1:GMX-INCP",-0.02)
        time.sleep(5)
        print("Move GMZ to 0 degree")
        epics.caput("X06MX-ES-DF1:GMZ-SETV",1)
        epics.caput("X06MX-ES-DF1:GMZ-INCP",-0.01)
        time.sleep(5)
        print("Move GMY to 5 degree")
        epics.caput("X06MX-ES-DF1:GMY-SETV",1)
        epics.caput("X06MX-ES-DF1:GMY-INCP",0.015)
        time.sleep(5)
        print("Move GMX to 73 degree")
        epics.caput("X06MX-ES-DF1:GMX-SETV",1)
        epics.caput("X06MX-ES-DF1:GMX-INCP",0.02)
