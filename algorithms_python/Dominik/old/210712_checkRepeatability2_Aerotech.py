...
def create_CSV_File():
    ...
    with open(day+'checkLRepeatability_GMZ.csv', 'w', newline='') as file:
...
#    plt.plot(p_x, '-r', label="Z")
    ...
    with open(day+'checkLRepeatability_GMZ.csv', 'a', newline='') as file:
        writer = csv.writer(file)
...
def checkLinearity_GMX_routine():
    ...
    if get_CHI==0 and OmegaRDB == 0:
        ...
        for i in range(0,5,1):
            ...
            epics.caput("X06MX-ES-DF1:GMY-SETV",0.1)
            epics.caput("X06MX-ES-DF1:GMY-INCP",0.005)
            time.sleep(7)
            print("Move GMX to 73 degree")
            epics.caput("X06MX-ES-DF1:GMX-SETV",0.1)
            epics.caput("X06MX-ES-DF1:GMX-INCP",0.005)
            time.sleep(7)
            print("Move GMX to 73 degree")
            epics.caput("X06MX-ES-DF1:GMY-SETV",0.1)
            epics.caput("X06MX-ES-DF1:GMY-INCP",-0.005)
            ...
            time.sleep(7) 
            print("Move GMX to 73 degree")
            epics.caput("X06MX-ES-DF1:GMZ-SETV",0.1)
            epics.caput("X06MX-ES-DF1:GMZ-INCP",-0.005)
            time.sleep(7) 
