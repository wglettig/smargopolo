...
ax.set_title("3D Plot: Measure Pin Vector SHZ",fontsize=14,fontweight="bold")
...
ax2.legend(loc='best')
ax2.set_title("2D Plot: Measure Pin Vector SHZ",fontsize=14,fontweight="bold")
fig2.show()
################################################################################
...
print("Der Winkelfehler Q4 muss vor der SHZ Korrektur akorrigiert werden!")
