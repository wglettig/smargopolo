...
int main() {
    ...
    exitOnError(result);
    printf("MCS2 position of channel %d: %lld", channel, position);
    ...
    printf("MCS2 set position of channel %d to %lld", channel, position);
    if (baseUnit == SA_CTL_UNIT_METER) printf("pm.\n");
    else printf("ndeg.\n"); // (baseUnit == SA_CTL_UNIT_DEGREE)
    ...
    // Print the results
    printf("MCS2 current position of channel %d: %lld", channel, position);
    if (baseUnit == SA_CTL_UNIT_METER) printf("pm.\n");
    else printf("ndeg.\n"); // (baseUnit == SA_CTL_UNIT_DEGREE)
