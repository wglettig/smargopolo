    ...
    for (uint32_t sequ = 0; sequ < 2; sequ++) {
        ...
        if (sequ == 0) {
            ...
            if (ret == 'c') {
                ...
                // The channel will generate a 1 탎 pulse (0.5 탎 high, 0.5 탎 low) once the position of channel 0 passed
                // 25um in rising direction. Furthermore every 50 탆 consecutive pulses are output.
                ...
                exitOnError(result);
                // Set pulse width to be 0.5 탎 high and 0.5 탎 low.
