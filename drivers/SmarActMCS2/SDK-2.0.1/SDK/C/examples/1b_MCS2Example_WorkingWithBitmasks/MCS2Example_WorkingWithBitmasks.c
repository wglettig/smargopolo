...
int main() {
    ...
    result = SA_CTL_GetProperty_i32(dHandle, channel, SA_CTL_PKEY_CHANNEL_STATE, &channelState, 0);
    exitOnError(result);
    ...
    result = SA_CTL_GetProperty_i32(dHandle, channel, SA_CTL_PKEY_REFERENCING_OPTIONS, &refOptions, 0);
    exitOnError(result);
