...
//        }
    ...
    printf("AASDFADSFSA\n");
    int64_t followingErrorLimit;
    result = SA_CTL_GetProperty_i64(dHandle, channel, SA_CTL_PKEY_FOLLOWING_ERROR_LIMIT, &followingErrorLimit, 0);
    printf("Channel %d Following Error: %ld\n", channel, followingErrorLimit);
    exitOnError(result);
